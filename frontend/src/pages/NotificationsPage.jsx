...
const MOCK_NOTIFICATIONS = [
  {
    ...
    content: 'Lịch xem nhà tại Vinhomes Golden River đã được môi giới xác nhận. Bạn sẽ nhận được nhắc nhở trước 2 giờ.',
    propertyId: 1,
  ...
  },
  {
    ...
    content: 'Căn hộ 3PN tại Quận 2 với giá 25 triệu/tháng, diện tích 90m², phù hợp với tiêu chí bạn đã lưu.',
    propertyId: 2,
  ...
  },
  {
    ...
    content: 'Bạn có lịch xem nhà tại Sun Wah Tower vào lúc 14:00 ngày 26/05/2026. Đừng quên mang theo giấy tờ tùy thân.',
    propertyId: 3,
  ...
  },
  {
    ...
    content: 'Căn hộ bạn đã lưu tại Landmark 81 đã giảm giá từ 35 triệu xuống 32 triệu/tháng.',
    propertyId: 4,
  ...
  },
  {
    ...
    content: 'Hợp đồng thuê nhà tại Quận 1 đã hết hạn vào ngày 20/05/2026. Liên hệ chủ nhà để gia hạn hoặc tìm nhà mới.',
    contractId: 2,
  ...
  },
  {
    ...
    content: 'Căn hộ studio tại Quận 2 với giá 12 triệu/tháng, nội thất đầy đủ, gần metro.',
    propertyId: 6,
    propertyName: 'Studio An Phú',
    price: '12.000.000',
    area: '45m²',
    bedrooms: '1 PN',
    image: null,
    ...
    >
      ...
      <div className="flex items-start gap-4">
        <div className={`flex shrink-0 items-center justify-center rounded-xl ${typeConfig?.lightBg || 'bg-slate-50'}`}>
          <div className={typeConfig?.color || 'bg-slate-500'}>
